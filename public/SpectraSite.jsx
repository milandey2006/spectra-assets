...
function WhatsAppButton({ go }) {
  ...
  return (
    <button className="sp-wa" aria-label="Chat on WhatsApp" onClick={onClick}>
      <svg width="30" height="30" viewBox="0 0 32 32" fill="#fff"><path d="M19.11 17.23c-.29-.15-1.7-.84-1.96-.93-.26-.1-.45-.15-.64.14-.19.29-.74.93-.9 1.12-.17.19-.33.21-.62.07-.29-.15-1.22-.45-2.32-1.43-.86-.76-1.44-1.7-1.6-1.99-.17-.29-.02-.44.13-.59.13-.13.29-.33.43-.5.14-.17.19-.29.29-.48.1-.19.05-.36-.02-.5-.07-.14-.64-1.55-.88-2.12-.23-.56-.47-.48-.64-.49h-.55c-.19 0-.5.07-.76.36-.26.29-1 .98-1 2.38 0 1.4 1.02 2.76 1.17 2.95.14.19 2.01 3.08 4.88 4.32.68.29 1.21.47 1.63.6.68.22 1.31.19 1.8.12.55-.08 1.7-.69 1.94-1.36.24-.67.24-1.24.17-1.36-.07-.12-.26-.19-.55-.34z"></path><path d="M16.01 3.2c-7.05 0-12.79 5.74-12.79 12.79 0 2.26.59 4.46 1.71 6.4L3.2 28.8l6.6-1.73a12.7 12.7 0 006.2 1.58h.01c7.05 0 12.79-5.74 12.79-12.79 0-3.42-1.33-6.63-3.75-9.05a12.7 12.7 0 00-9.04-3.61zm0 23.31h-.01a10.5 10.5 0 01-5.36-1.47l-.38-.23-3.92 1.03 1.05-3.82-.25-.39a10.53 10.53 0 01-1.61-5.61c0-5.85 4.76-10.61 10.62-10.61 2.84 0 5.5 1.11 7.51 3.12a10.55 10.55 0 013.11 7.5c0 5.86-4.76 10.62-10.62 10.62z"></path></svg>
    </button>
  );
}
